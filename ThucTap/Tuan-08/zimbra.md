...
| IP Address | 172.16.16.237 | 192.168.136.131 |
| Subnet | /24 | /24 |
...
**Output mong đợi:**
```
PING mail.lab.local (192.168.136.131) 56(84) bytes of data.
64 bytes from mail.lab.local (192.168.136.131): icmp_seq=1 ttl=64 time=0.021 ms
```
...
- [ ] Vào được Admin Console tại `https://192.168.136.131:7071`
- [ ] Đăng nhập Admin thành công
- [ ] Vào được WorldClient tại `https://192.168.136.131`
